          ...
          <div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@meryerevan.am" className="hover:text-primary-foreground transition-colors">info@meryerevan.am</a>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Northern Ave 1,<br />Yerevan, Armenia</span>
              </li>
            </ul>
          </div>
        </div>
