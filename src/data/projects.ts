...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descriptionAm: '«Հանրdelays Հdelays» մetro station description in Armenian needs proper translation.',
    ...
    budgetLabelAm: 'Վdelays',
    budgetLabelEn: 'Restoration budget:',
    buttonLabel: 'Стать спонсором',
    buttonLabelAm: 'Դdelays',
    buttonLabelEn: 'Become a Sponsor',
    address: 'метро Площадь Республики',
    addressAm: 'Հdelays Հdelays մdelay',
